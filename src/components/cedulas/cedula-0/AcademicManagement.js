...
const AcademicManagement = () => {
    ...
    return (
        ...
        >
            {formik => (
                <>
                    <h4>5. Gestión académica</h4>
                    <p>Anotar las actividades o puestos académicos desempeñados en orden cronológico decreciente: primero la más reciente (o actual) y de último la más antigüa.</p>
                    <Form>
